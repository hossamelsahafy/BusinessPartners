  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-4 mt-4">
      {Sectors.map((s) => (
        <div
          key={s.Name}
          className="flex items-center flex-col rounded-lg shadow-[4px_4px_12px_rgba(28,47,140,0.2)] p-4 justify-center gap-4"
        >
          <Image src={s.Image} width={200} height={200} alt={s.Name} className="object-center" />
